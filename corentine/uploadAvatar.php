<?php
  ...
  *réponse {true}*/
  ...
  try{
    ...
    $type = $_FILES_['image']['type'];
    $fluxSmall = createImageFromFile($name);
    $fluxLarge = createImageFromFile($name);
    $flux = fopen($name,'r');
    ...
    $data->storeAvatar(['avatar_small'=>$fluxSmall,'avatar_large'=>$fluxLarge,'avatar_type'=>'image/png'],$userId);
